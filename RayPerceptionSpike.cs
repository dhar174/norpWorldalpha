...
namespace Unity.MLAgents
{
    ...
    /// </summary>
    public class RayPerceptionSpike : MonoBehaviour//, //IDisposable
    {
        ...
        public List<Transform> CurrentTargetTypeListCopy1= new List<Transform>();
    ...
    //    RaycastHit2D hit4b ;
     //   RaycastHit2D hit4c;
        ...
        private NorpAgentSpike norpAgent;
       ...
       // public List<Collider2D> circleList  = new List<Collider2D>();
        ...
        public virtual IList<float> Perceive(float rayDistance,
            ...
            float startOffset, float endOffset)
        {
            ...
            //print("rayper accessed");
                // if (!norpAI)
                // {
                norpAI = gameObject.GetComponent<NorpAISpike>();
                // }

                norpAgent = this.gameObject.GetComponent<NorpAgentSpike>();
           ...
           float[] subList = new float[detectableObjectLength + 5];
            ...
            Collider2D[] circle = new Collider2D[100];
            ...
            //print("circlelist count="+circleList.Count);
            if (listcount2 > 10)
                {
                  //  poop temp =  new poop();
              ...
              //  temp.getit();
                ...
                //print("best target count=" + temp2count);
                ...
                else
                {
                    if (listcount2 < 100)
                    {
                        ...
                        for (int runs = 0; runs < (100 - circleList.Count); runs++)
                        {
                            NullObjects.Add(0f);
                        }
                    }
                ...
                foreach (Collider2D coll in circleList)
                {
                    ...
                    {
                        if (coll.gameObject != this.gameObject && coll.gameObject!=null)
                        {
            ...
            CurrentTargetTypeListCopy1 = CurrentTargetTypeList;
